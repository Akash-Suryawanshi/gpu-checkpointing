# Experiment results: long-form record

The [short version](results.md) has what was done, what was found, and what
failed. This file keeps the full per-run detail, qualifications and provenance.
